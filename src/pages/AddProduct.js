...
const AddProduct = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        console.log('AddProduct - Loading dropdown data...');
        ...
        console.log('AddProduct - Loaded data:', {
        ...
        if (baseCurrency) {
          ...
          console.log('AddProduct - Set default currency:', baseCurrency.id);
        }
      } catch (err) {
        console.error('AddProduct - Error loading dropdown data:', err);
  ...
  return (
    <AdminLayout 
      ...
      description="Create a new product entry for your inventory catalog."
    >
      {error && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    {console.log('AddProduct - Rendering categories dropdown:', categories.length, categories) || 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    {console.log('AddProduct - Rendering units dropdown:', units.length, units) || 
                     units.map(unit => (
