...
const EditCategory = () => {
  return (
    <AdminLayout 
      title="Edit Category" 
      description="Managing details for 'Premium Fruits' harvest collection."
    >
        ...
        <div className="col-span-8 flex flex-col gap-6">
          ...
          <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100/50">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input 
                  className="w-full rounded-xl border-outline-variant focus:border-primary focus:ring-primary bg-surface-bright p-3 outline-none" 
                  type="text" 
                  defaultValue="Premium Fruits"
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="flex items-center bg-surface-container rounded-xl px-3 border border-outline-variant">
                  ...
                  <input 
                    className="w-full border-none bg-transparent focus:ring-0 p-3 outline-none" 
                    type="text" 
                    defaultValue="premium-fruits"
                  />
                </div>
              ...
              <div className="col-span-2 space-y-2">
                ...
                <textarea 
                  className="w-full rounded-xl border-outline-variant focus:border-primary focus:ring-primary bg-surface-bright p-3 outline-none resize-none" 
                  rows="4"
                  defaultValue="A curated collection of Pakistan's finest seasonal produce, including export-quality Sindhri Mangoes, Swat Peaches, and Hand-picked Kinnows. Only the top 5% of harvests make it into this category."
                />
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100/50">
            ...
            <div className="flex gap-8 items-start">
              <div className="relative group h-48 w-64 rounded-2xl overflow-hidden bg-surface-container-low border-2 border-dashed border-outline-variant flex items-center justify-center">
                <img 
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                  <button className="p-2 bg-white rounded-full text-on-surface hover:scale-110 transition-transform">
                    <span className="material-symbols-outlined">refresh</span>
                  </button>
                  <button className="p-2 bg-white rounded-full text-error hover:scale-110 transition-transform">
                    <span className="material-symbols-outlined">delete</span>
                  </button>
                </div>
              </div>
              <div className="flex-1 space-y-4">
                <p className="text-on-surface-variant text-base">Upload a high-resolution hero image. This will be shown at the top of the category page.</p>
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-surface-container text-outline rounded-full text-xs">JPG/PNG</span>
                  <span className="px-3 py-1 bg-surface-container text-outline rounded-full text-xs">Max 5MB</span>
                  <span className="px-3 py-1 bg-surface-container text-outline rounded-full text-xs">1200 x 600px recommended</span>
                </div>
                <button className="mt-4 px-6 py-2 rounded-xl bg-secondary-container text-on-secondary-container font-medium hover:brightness-105 transition-all flex items-center gap-2">
        ...
        <div className="col-span-4 flex flex-col gap-6">
          ...
          <section className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100/50">
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1 p-4 rounded-2xl bg-green-50 border-2 border-primary flex items-center justify-between cursor-pointer">
                <span className="text-sm font-medium text-primary">Active</span>
                <span className="material-symbols-outlined text-primary" style={{fontVariationSettings: "'FILL' 1"}}>check_circle</span>
              </div>
              <div className="flex-1 p-4 rounded-2xl bg-surface-container-low border border-outline-variant flex items-center justify-between opacity-50 cursor-pointer grayscale">
                <span className="text-sm font-medium text-outline">Hidden</span>
          ...
          {/* Danger Zone */}
          <section className="bg-error-container/20 rounded-3xl p-8 border-2 border-error/10">
            ...
            <p className="text-on-error-container text-base mb-6">Deleting this category will unassign all products and cannot be undone.</p>
            <button className="w-full py-3 rounded-xl bg-error text-on-error font-medium hover:brightness-90 transition-all flex items-center justify-center gap-2">
      ...
      <div className="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-100">
        ...
        <button className="px-8 py-2.5 rounded-xl bg-primary text-white font-medium shadow-lg shadow-green-900/20 hover:brightness-110 transition-all">
          Save Category
        </button>
      </div>
    </AdminLayout>
