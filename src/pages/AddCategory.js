  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (previews.length > 0) {
        console.log('Uploading image:', previews[0]);
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-6">
            ...
            <section className="bg-white rounded-2xl p-8 shadow-sm border border-gray-50 flex-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-on-surface">Category Image</h2>
              </div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (files && files.length > 0) {
                      console.log('Processing files:', files[0]);
        ...
        <div className="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
          ...
          >
            {loading || uploading ? 'Saving Category...' : 'Save Category'}
          </button>
        </div>
      </form>
    </AdminLayout>
